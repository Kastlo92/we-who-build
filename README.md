...
- [ ] buttons logic:
 ...
 -[ ] when we're placing the tiles we should get a "preview" of the selected building in a more transparent color.
		...
		--> we could also get a duplicate of every tile in its pre-positioned phase (more transparent) and use that, but that
		--> would require having a duplicate of my atlas with another set of coordinates etc...
